<?php
    //Relative path to SASS colour definitions
                ...
                if (!empty($line) && substr($line, 0, 1) === '$') {
                    ...
                    ?>
                        <li style="background-color: <?= $colour[1] ?>;">
                            <dt class="clipboard" data-clipboard-text="<?= $colour[0] ?>"><?= $colour[0] ?></dt>
                            <dd class="clipboard" data-clipboard-text="<?= $colour[1] ?>"><?= $colour[1] ?></dd>
                        </li>
                    <?php
                }
            }
