<?php
	...
	echo 'Winner: ' . $winnerRatingToCalculate . ' + ' . $winnerDifference . ' = ' . $winnerNewRating;
	echo '<br />';
	echo 'Loser: ' . $loserRatingToCalculate . ' - ' . $loserDifference . ' = ' . $loserNewRating;
